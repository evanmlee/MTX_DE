...
#######====================== M6_strict_MTX.R ======================#######
#M6_MTX is a wrapper script for MTX_model using feature-level DNA covariates.

#Model specifcations: log transform, total sum scaling (TSS) normalization, fixed_effects of Phenotype (in metadata file).
#Model specifcations (continued): using per-feature DNA abundances in input_dnadata. 'strict' rna_dna_filter 
