...
#######====================== M1_lenient_MTX.R ======================#######
#M1_lenient_MTX is a wrapper script for MTX_model using no DNA covariates. Lenient (feature-level) zero filtering is used. 
...
#Model specifications: min-prevalence
